...
import { Download, MapPin, Calendar, Users, Mail, Instagram } from 'lucide-react';

// --- SEO CONFIG ---
export const metadata: Metadata = {
  title: 'DriftWheels - O App #1 de Drift no Brasil',
  description: 'Encontre pistas, participe de eventos, gerencie sua garagem e conecte-se com a maior comunidade de drift do país.',
  openGraph: {
    title: 'DriftWheels - A Cultura do Drift no Seu Bolso',
    description: 'Baixe agora e conecte-se com pilotos, pistas e eventos.',
...
export default function LandingPage() {
  // Cor principal definida via Tailwind Arbitrary Value: [#FF4500]
  
  return (
    <div className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-[#FF4500] selection:text-black">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl opacity-20 pointer-events-none">
          <div className="absolute top-20 left-20 w-96 h-96 bg-[#FF4500]/20 rounded-full blur-3xl mix-blend-screen animate-pulse"></div>
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl mix-blend-screen"></div>
        </div>

        <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[#FF4500] text-xs font-bold uppercase tracking-wider mb-6 hover:bg-white/10 transition-colors cursor-default">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF4500] to-[#ff784b]">
              No Seu Bolso.
            </span>
          </h1>
          ...
          <div id="download" className="flex flex-col sm:flex-row items-center justify-center gap-4 scroll-mt-24">
            {/* Apple Store Button */}
            <Link href="https://apps.apple.com" className="flex items-center gap-3 bg-white text-black px-6 py-3.5 rounded-xl hover:scale-105 transition-transform duration-200 w-full sm:w-auto justify-center shadow-lg shadow-white/10">
            ...
            {/* Google Play Button */}
            <Link href="https://play.google.com/store/apps/details?id=com.the_one.DriftWheels" className="flex items-center gap-3 bg-white/10 border border-white/20 backdrop-blur-sm px-6 py-3.5 rounded-xl hover:bg-white/20 transition-all duration-200 w-full sm:w-auto justify-center">
          ...
          <div className="mt-20 relative mx-auto max-w-4xl">
             <div className="aspect-video bg-neutral-900 rounded-2xl border border-white/10 shadow-2xl flex items-center justify-center overflow-hidden group hover:border-[#FF4500]/30 transition-colors">
                ...
                <div className="text-center z-10 p-6 flex flex-col items-center">
                    ...
                    <img 
                        src="/assets/logo.png" 
                        alt="Logo" 
                        className="w-20 h-20 mb-6 rounded-2xl border border-[#FF4500]/50 shadow-lg shadow-[#FF4500]/20"
                    />
                    <h3 className="text-2xl font-bold text-white">Telemetria & Pistas</h3>
                    <p className="text-gray-400 mt-2 text-sm">A interface definitiva para pilotos.</p>
                </div>
             </div>
          </div>
        </div>
      ...
      <section className="py-24 relative overflow-hidden border-t border-white/5">
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
             <Link href="#download" className="bg-[#FF4500] text-black font-bold py-4 px-8 rounded-xl hover:bg-[#ff5e22] transition-colors flex items-center justify-center gap-2 shadow-lg shadow-[#FF4500]/20 transform hover:scale-105 duration-200">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li>
                    <Link href="/" className="hover:text-[#FF4500] transition-colors flex items-center gap-1">
                        Início
                    </Link>
                </li>
                <li>
                    <Link href="#features" className="hover:text-[#FF4500] transition-colors flex items-center gap-1">
                        Funcionalidades
                    </Link>
                </li>
                <li>
                    <Link href="#download" className="hover:text-[#FF4500] transition-colors flex items-center gap-1">
                        Download App
                    </Link>
                </li>
                {/* LINKS LEGAIS - ROTAS INTERNAS */}
                <li className="pt-2">
                    <Link href="/terms" className="hover:text-[#FF4500] transition-colors flex items-center gap-1">
                        Termos de Uso
                    </Link>
                </li>
                <li>
                    <Link href="/privacy" className="hover:text-[#FF4500] transition-colors flex items-center gap-1">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                ...
                <li className="flex items-center gap-2">
                    <Instagram className="w-4 h-4 text-[#FF4500]" />
          ...
          <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-600 text-sm gap-4">
            ...
            <div className="flex gap-4">
                ...
                <Link href="/terms" className="hover:text-gray-400 transition-colors">Termos</Link>
            </div>
          </div>
        </div>
      </footer>
...
function FeatureCard({ icon, title, desc }: { icon: React.ReactNode, title: string, desc: string }) {
  return (
    <div className="bg-white/5 border border-white/5 p-8 rounded-2xl hover:bg-white/10 transition-colors group cursor-default">
      <div className="mb-6 p-4 bg-black/40 w-fit rounded-xl group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-black/50 border border-white/5 group-hover:border-[#FF4500]/20">
        {icon}
      </div>
      <h3 className="text-xl font-bold mb-3 text-white group-hover:text-[#FF4500] transition-colors">{title}</h3>
